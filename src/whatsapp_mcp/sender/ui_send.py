...
in :mod:`whatsapp_mcp.sender.verify` (the post-hoc DB poller); this
...
from whatsapp_mcp.sender.ax_assert import (
    _assert_first_search_result_matches,
    assert_focused_chat_matches,
)
from whatsapp_mcp.sender.deeplink import send_deeplink
from whatsapp_mcp.sender.osascript_send import press_return, type_string
    ...
    * Anything else: raises :class:`NotImplementedError` with the
    ...
    Returns:
        ...
        * ``send_started_unix``: Unix-epoch wall-clock captured BEFORE
          ...
          :func:`whatsapp_mcp.sender.verify.poll_for_outgoing` so the
