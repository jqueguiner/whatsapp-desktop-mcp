...
:mod:`whatsapp_desktop_mcp.sender`. Plan 06 re-tests this with an AST walk.

Plans 04/05 consume this surface; do NOT reach past it into the
sibling modules (e.g. don't ``from whatsapp_desktop_mcp.reader.connection
...
from whatsapp_desktop_mcp.reader.chats import (
    find_chat_by_id,
    find_chat_by_jid,
    list_chats,
)
from whatsapp_desktop_mcp.reader.connection import open_ro
from whatsapp_desktop_mcp.reader.contacts import (
    resolve_lid_to_phone,
    resolve_phone_to_lid,
    search_contacts,
)
from whatsapp_desktop_mcp.reader.groups import get_group_info, get_members
from whatsapp_desktop_mcp.reader.media import resolve_media_ref
from whatsapp_desktop_mcp.reader.messages import (
...
from whatsapp_desktop_mcp.reader.search import like_search
from whatsapp_desktop_mcp.reader.tombstones import is_tombstone
