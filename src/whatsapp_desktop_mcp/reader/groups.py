...
from whatsapp_desktop_mcp.models import GroupInfo, GroupMember
...
from whatsapp_desktop_mcp.reader.messages import _parse_jid
from whatsapp_desktop_mcp.reader.schema_v1 import _SQL_GROUP_INFO, _SQL_GROUP_MEMBERS
...
async def get_group_info(chat_id: int) -> GroupInfo | None:
    ...
    :func:`whatsapp_desktop_mcp.reader.chats.find_chat_by_id`).
    """
